...
connection = pymysql.connect(host='localhost',user='root',password='loki@123',db='cv')
...
def run():
    ...
    link = '[©Developed by Kolla Raghavendra Lokesh](https://www.linkedin.com/in/kolla-lokesh-b8b994201/)'
    ...
    if choice == 'User':
        ...
        if st.button('Login'):
            if ad_user == 'loki' and ad_password == 'loki@123':
                st.success("Welcome Lokesh!")
                # Display Data
